...
def IK(pos):  # pos = [x, y, z]
    ...
    coxa = 154  # coxa length
    femur = 82  # femur length
    tibia = 82  # tibia length
...
def IK_leg(pos, LegID=1):  # modified version of IK(), and will take the offset angles of each leg into account
    ...
    offset_angles = [0, 45, 135, 180, 225,
                     315]  # <- put your original values; there is not limit on numbers of leg, but they should all be between 0 ~ 360 degrees
